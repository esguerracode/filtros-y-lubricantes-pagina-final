...
export async function sendOrderConfirmationEmail({
  ...
  <body style="margin:0;padding:0;background:#f4f4f4;
    ...
    <div style="max-width:600px;margin:0 auto;background:#fff;
      ...
      <div style="background:#1a3a5c;padding:32px;text-align:center">
        <h1 style="color:#fff;margin:0;font-size:24px">
          Filtros y Lubricantes del Llano
        </h1>
        <p style="color:#a0c4e8;margin:8px 0 0">
          Confirmación de tu pedido
        </p>
      </div>

      <!-- HERO -->
      <div style="background:#f0fdf4;padding:24px;text-align:center;
      ...
      <div style="padding:24px">
        <div style="background:#f8fafc;border-radius:8px;
          ...
          <p style="margin:0 0 8px;color:#888;font-size:12px;
            text-transform:uppercase">Referencia del pedido</p>
          <p style="margin:0;font-size:20px;font-weight:bold;
            color:#1a3a5c">${reference}</p>
        ...
        <!-- PRODUCTOS -->
        <h3 style="color:#1a3a5c;margin:0 0 12px">
          Productos pedidos
        </h3>
          ...
          <thead>
            <tr>
              <th style="text-align:left;padding:8px 0;
                border-bottom:2px solid #e0e0e0;color:#888;
          ...
          <tfoot>
            <tr>
              <td colspan="2" style="padding:12px 0;
                font-weight:bold;color:#1a3a5c">TOTAL</td>
              <td style="padding:12px 0;font-weight:bold;
                font-size:18px;color:#1a3a5c;text-align:right">
                $${amount} COP
              </td>
            </tr>
          </tfoot>
      ...
      <div style="background:#f8fafc;padding:20px;text-align:center;
        ...
        <p style="margin:0;color:#888;font-size:12px">
          ...
          <a href="https://filtrosylubricantes.co" 
            style="color:#1a3a5c">filtrosylubricantes.co</a>
        </p>
      </div>
    </div>
  </body>
    ...
    return await resend.emails.send({
        from: 'Filtros y Lubricantes <pedidos@filtrosylubricantes.co>',
        to,
