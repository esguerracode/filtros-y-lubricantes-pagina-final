...
product_id_map = {
    ...
    "MOTORCRAF 10W30": 126, "MOTORCRAF 5W30": 110, "KIT FORD RANGER FILTROS NAC": 107,
...
if os.path.exists(constants_path):
    ...
    print(f"SUCCESS: Linked {updated_count} unique product images.")
else:
    print("ERROR: constants.ts not found.")
