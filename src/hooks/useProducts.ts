...
const LOCAL_IMAGE_OVERRIDE: Record<string, string> = {
  ...
  // Nota: Para aceite y combustible usamos genéricos si no hay específico aún, o los que coincidan
  'Filtro Aceite OLP 067 (Toyota Revo)': '/images/products/toyota_revo_filters_kit_studio_1771121738181.png', // Usando kit como fallback visual rico
  'Filtro Combustible FLP 476 (Toyota Revo)': '/images/products/toyota_revo_filters_kit_studio_1771121738181.png',
  ...
  // ACEITES MOTORCRAFT
  'Aceite Motorcraft 10W30 (1/4 Galón)': '/images/products/motorcraft_5w30_oil_quart_1771119903396.png', // Placeholder 5w30 visualmente similar
  'Aceite Motorcraft 5W30 (1/4 Galón)': '/images/products/clean_motorcraft_5w30_quart_1771120280601.png',

  // FILTROS INDIVIDUALES (Mapeo inteligente)
  'Filtro Aire Motor MB3Z-9601C (Ford Original 2025)': '/images/products/ford_air_filter_mb3z19n619c_1771119889411.png',
  'Filtro Aire Acondicionado MB3Z19N619C (Ford Original 2025)': '/images/products/ford_cabin_filter_mb3z19n619c_1771120242359.png',
};
